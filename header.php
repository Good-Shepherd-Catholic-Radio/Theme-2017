								...
								<div id="jp_container_1" class="jp-audio-stream" role="application" aria-label="media player">
									<div class="jp-type-single">
										...
										<div class="jp-gui jp-interface row expanded">
											...
											<div class="title-container jp-details text-center medium-4 columns">
												<div class="jp-title" aria-label="title">
													<?php _e( 'Listen Live!', 'good-shepherd-catholic-radio' ); ?>
												</div>
											</div>

											<div class="jp-volume-controls small-2 offset-small-1 medium-7 columns">
												...
												<div class="row expanded small-collapse">
													...
													<div class="volume-bar-container small-5 small-offset-1 columns">
